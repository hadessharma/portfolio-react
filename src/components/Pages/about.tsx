...
const About: React.FC = () => {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-start">
        {/* Left Column: About Me */}
        <div className="pr-8 text-left">
          <h2 className="text-lg font-medium text-cyan-400 mb-2 text-center">Get To Know More</h2>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-100 mb-6 text-center">About Me</h1>
